            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                ...
                                <h2><strong>4,000</strong><span>CFA</span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    ...
                                    <li><i class="far fa-times-circle"></i>Tire Shinnig</li>
                                </ul>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                ...
                                <h2><strong>10,000</strong><span>CFA</span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Exterior Detailing</li>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                <h3>Premuim Cleaning</h3>
                                <h2><strong>20,000</strong><span>CFA</span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
