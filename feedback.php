                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="contact-form">
                            <div id="success"></div>
                            <form action="send_feed.php" method="POST" name="sentMessage" id="contact">
                            <div class="control-group">
                                <input type="text" class="form-control" id="name" placeholder="Your Name" required="required" name="name" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="number" class="form-control" id="phone" placeholder="Your Number" required="required" name="phone" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
